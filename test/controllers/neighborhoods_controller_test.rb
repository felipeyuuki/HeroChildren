...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { nameNeighborhood: @neighborhood.nameNeighborhood, sector_id: @neighborhood.sector_id }
    end
  ...
  test "should update neighborhood" do
    patch :update, id: @neighborhood, neighborhood: { nameNeighborhood: @neighborhood.nameNeighborhood, sector_id: @neighborhood.sector_id }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end
