...
class SectorsControllerTest < ActionController::TestCase
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post :create, sector: { codeSector: @sector.codeSector, descriptionSector: @sector.descriptionSector }
    end
  ...
  test "should update sector" do
    patch :update, id: @sector, sector: { codeSector: @sector.codeSector, descriptionSector: @sector.descriptionSector }
    assert_redirected_to sector_path(assigns(:sector))
  end
