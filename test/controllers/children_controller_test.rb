...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { birthDateChild: @child.birthDateChild, mother: @child.mother, nameChild: @child.nameChild, team_id: @child.team_id }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { birthDateChild: @child.birthDateChild, mother: @child.mother, nameChild: @child.nameChild, team_id: @child.team_id }
    assert_redirected_to child_path(assigns(:child))
  end
